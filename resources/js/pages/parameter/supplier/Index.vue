...
const name = ref('');
const search = () => {
    router.get(route('suppliers.index', { name: name.value }, {
        preserveState: true,
        replace: true
    }))
};
                    ...
                    <div class="mb-8 flex items-center justify-between gap-8">
                        ...
                        <div class="flex shrink-0 flex-col gap-2 sm:flex-row">
                            ...
                            <button
                                ...
                                type="button">
                                <Link :href="route('suppliers.create')" class="flex gap-3">
                            ...
                            <tr v-for="supplier in suppliers.data" :key="supplier.id">
                                <td class="border-blue-gray-50 border-b p-4">
                                    <div class="flex items-center gap-3">
                                        <Avatar :name="letter(supplier.name, supplier.surname)" />
                                ...
                                <td class="border-blue-gray-50 border-b p-4">
                                    <div class="w-max">
                                        <div :class="supplier.is_active ? 'bg-green-500/20' : 'bg-red-500/20'"
                                            ...
                                            <span v-if="supplier.is_active" class="">Activo</span>
                                        ...
                                        <AlertDialogContent>
                                            <AlertDialogHeader>
                                                ...
                                                <AlertDialogDescription>
                                                    ...
                                                    fornecedor
                                                    <strong> <span class="text-[#EC3636]">{{ supplier.name }}</span>
                                                    </strong>.
                                                </AlertDialogDescription>
                                            </AlertDialogHeader>
                                            <AlertDialogFooter>
                                                ...
                                                <AlertDialogAction class="cursor-pointer bg-[#EC3636]"
                                                    @click="deleteSupplier(supplier.id)">Sim, Excluir
                                                </AlertDialogAction>
                                            </AlertDialogFooter>
                                        </AlertDialogContent>
                                    </AlertDialog>
