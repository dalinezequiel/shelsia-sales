...
const deletePaymentMethod = (id: number) => {
    router.delete(route('payment_methods.destroy', id), {
        preserveScroll: true,
        onSuccess: () => toast.success('Forma de pagmento excluída com sucesso.'),
        onError: () => toast.error('Ocorreu um erro ao tentar excluir forma de pagamento.')
    })
}
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <ParameterLayout>
            <div class="relative flex h-full w-full flex-col bg-white bg-clip-border text-gray-700">
                    ...
                    <div class="mb-8 flex items-center justify-between gap-8">
                        ...
                        <div class="flex shrink-0 flex-col gap-2 sm:flex-row">
                            ...
                            <button
                                ...
                                type="button">
                                <Link :href="route('payment_methods.create')" class="flex gap-3">
                    ...
                    <table class="mt-4 w-full min-w-max table-auto text-left">
                        ...
                        <tbody>
                            <tr v-for="paymentMethod in paymentMethods.data" :key="paymentMethod.id">
                                ...
                                <td class="border-blue-gray-50 border-b p-4">
                                    <div class="w-max">
                                        <div :class="paymentMethod.is_active ? 'bg-green-500/20' : 'bg-red-500/20'"
                                            ...
                                            <span v-if="paymentMethod.is_active" class="">Activo</span>
                                ...
                                <td class="border-blue-gray-50 border-b p-4 text-center">
                                    <button
                                        ...
                                        type="button">
                                        <Link :href="route('payment_methods.edit', paymentMethod.id)">
                                        ...
                                        <AlertDialogContent>
                                            ...
                                            <AlertDialogFooter>
                                                ...
                                                <AlertDialogAction class="cursor-pointer bg-[#EC3636]"
                                                    @click="deletePaymentMethod(paymentMethod.id)">Sim, Excluir
                                                </AlertDialogAction>
                                            </AlertDialogFooter>
                                        </AlertDialogContent>
                                    </AlertDialog>
                ...
                <Pagination :list="paymentMethods" />
            </div>
        </ParameterLayout>
    </AppLayout>
</template>
