...
const form = useForm({
    description: '',
    operation_type: 'payment_receipt',
    observation: '',
    is_active: true
});
...
const operation = () => form.operation_type === 'receipt' ? 'Recebimento'
    : (form.operation_type === 'payment' ? 'Pagamento' : 'Pagamento e Recebimento')
                ...
                <div class="mx-4">
                    <form @submit.prevent="submit" class="space-y-6">
                        <div class="grid gap-2">
                            ...
                            <Input id="name" v-model="form.description" class="mt-1 block w-full"
                        ...
                        <div class="grid gap-2">
                            ...
                            <Select defaultValue="Pagamento" id="operation_type" v-model="form.operation_type">
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem value="payment_receipt" selected> Pagamento e Recebimento </SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
