...
const props = defineProps<{ productCategory: ProductCategory }>();

const form = useForm({
    description: props.productCategory.description,
    observation: props.productCategory.observation,
    is_active: Boolean(props.productCategory.is_active)
});
