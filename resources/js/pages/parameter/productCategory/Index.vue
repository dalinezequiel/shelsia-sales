...
const search = () => {
    router.get(route('product_categories.index', { description: description.value }, {
        preserveState: true,
        replace: true
    }))
};
...
const deleteProductCategory = (id: number) => {
    router.delete(route('product_categories.destroy', id), {
        preserveScroll: true,
        onSuccess: () => toast.success('Categoria de produto excluída com sucesso.'),
        onError: () => toast.error('Ocorreu um erro ao tentar excluir categoria de produto.')
    })
}
            ...
            <div class="relative flex h-full w-full flex-col bg-white bg-clip-border text-gray-700">
                <div class="relative mx-4 mt-1 overflow-hidden rounded-none bg-white bg-clip-border text-gray-700">
                    <div class="mb-8 flex items-center justify-between gap-8">
                        <div>
                            ...
                            <p
                                ...
                                Veja informações sobre categorias de produtos
                            </p>
                        </div>
                        <div class="flex shrink-0 flex-col gap-2 sm:flex-row">
                            ...
                            <button
                                ...
                                type="button">
                                <Link :href="route('product_categories.create')" class="flex gap-3">
                    ...
                    <div class="flex flex-col items-center justify-between gap-4 md:flex-row">
                        <div class="block w-full overflow-hidden md:w-max">
                            <nav>
                                <Tablist :list="productCategories" />
                            </nav>
                        </div>
                ...
                <div class="overflow-auto px-0 pt-6 pb-2">
                    <table class="mt-4 w-full min-w-max table-auto text-left">
                        ...
                        <tbody>
                            <tr v-for="productCategory in productCategories.data" :key="productCategory.id">
                                <td class="border-blue-gray-50 border-b p-4">
                                    <div class="flex items-center gap-3">
                                        <Avatar :name="letter(productCategory.description)" />
                                ...
                                <td class="border-blue-gray-50 border-b p-4">
                                    <div class="w-max">
                                        <div :class="productCategory.is_active ? 'bg-green-500/20' : 'bg-red-500/20'"
                                            ...
                                            <span v-if="productCategory.is_active" class="">Activo</span>
                                ...
                                <td class="border-blue-gray-50 border-b p-4 text-center">
                                    <button
                                        ...
                                        type="button">
                                        <Link :href="route('product_categories.edit', productCategory.id)">
                                        ...
                                        <AlertDialogContent>
                                            ...
                                            <AlertDialogFooter>
                                                ...
                                                <AlertDialogAction class="cursor-pointer bg-[#EC3636]"
                                                    @click="deleteProductCategory(productCategory.id)">Sim, Excluir
                                                </AlertDialogAction>
                                            </AlertDialogFooter>
                                        </AlertDialogContent>
                                    </AlertDialog>
                ...
                <Pagination :list="productCategories" />
            </div>
        </ParameterLayout>
    </AppLayout>
</template>