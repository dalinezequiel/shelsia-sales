...
const search = () => {
    router.get(route('periods.index', { description: description.value }, {
        preserveState: true,
        replace: true
    }))
};
...
const deletePeriod = (id: number) => {
    router.delete(route('periods.destroy', id), {
        preserveScroll: true,
        onSuccess: () => toast.success('Período excluída com sucesso.'),
        onError: () => toast.error('Ocorreu um erro ao tentar excluir período.')
    })
}
            ...
            <div class="relative flex h-full w-full flex-col bg-white bg-clip-border text-gray-700">
                    ...
                    <div class="mb-8 flex items-center justify-between gap-8">
                        <div>
                            ...
                            <p class="block font-sans text-sm leading-relaxed font-normal text-gray-700 antialiased">
                                Veja informações sobre todos períodos
                            </p>
                        </div>
                        <div class="flex shrink-0 flex-col gap-2 sm:flex-row">
                            ...
                            <button
                                ...
                                type="button">
                                <Link :href="route('periods.create')" class="flex gap-3">
                ...
                <div class="overflow-auto px-0 pt-6 pb-2">
                    <table class="mt-4 w-full min-w-max table-auto text-left">
                        ...
                        <tbody>
                            <tr v-for="productCategory in periods.data" :key="productCategory.id">
                                ...
                                <td class="border-blue-gray-50 border-b p-4 text-center">
                                    <button
                                        ...
                                        type="button">
                                        <Link :href="route('periods.edit', productCategory.id)">
                                    ...
                                    <button
                                        ...
                                        type="button">
                                        <Link :href="route('periods.show', productCategory.id)">
                                        ...
                                        <AlertDialogContent>
                                            ...
                                            <AlertDialogFooter>
                                                ...
                                                <AlertDialogAction class="cursor-pointer bg-[#EC3636]"
                                                    @click="deletePeriod(productCategory.id)">Sim, Excluir
                                                </AlertDialogAction>
                                            </AlertDialogFooter>
                                        </AlertDialogContent>
                                    </AlertDialog>
