...
const deleteUnit = (id: number) => {
    router.delete(route('units.destroy', id), {
        preserveScroll: true,
        onSuccess: () => toast.success('Unidade de medida excluída com sucesso.'),
        onError: () => toast.error('Ocorreu um erro ao tentar excluir unidade de medida.')
    })
}
                    ...
                    <div class="mb-8 flex items-center justify-between gap-8">
                        ...
                        <div class="flex shrink-0 flex-col gap-2 sm:flex-row">
                            ...
                            <button
                                ...
                                type="button">
                                <Link :href="route('units.create')" class="flex gap-3">
                            ...
                            <tr v-for="unit in units.data" :key="unit.id">
                                <td class="border-blue-gray-50 border-b p-4">
                                    <div class="flex items-center gap-3">
                                        <Avatar :name="letter(unit.description)" />
                                ...
                                <td class="border-blue-gray-50 border-b p-4">
                                    <div class="w-max">
                                        <div :class="unit.is_active ? 'bg-green-500/20' : 'bg-red-500/20'"
                                            ...
                                            <span v-if="unit.is_active" class="">Activo</span>
                                        ...
                                        <AlertDialogContent>
                                            ...
                                            <AlertDialogFooter>
                                                ...
                                                <AlertDialogAction class="cursor-pointer bg-[#EC3636]"
                                                    @click="deleteUnit(unit.id)">Sim, Excluir
                                                </AlertDialogAction>
                                            </AlertDialogFooter>
                                        </AlertDialogContent>
                                    </AlertDialog>
