...
<template>
    <div class="relative flex h-full w-full flex-col bg-white bg-clip-border text-gray-700">
        <div class="relative mx-4 mt-2 overflow-hidden rounded-none bg-white bg-clip-border text-gray-700">
            ...
            <div class="flex flex-col items-center justify-between gap-4 md:flex-row">
                <div class="block w-full overflow-hidden md:w-max">
                    <nav>
                        <ul role="tablist" class="bg-blue-gray-50 bg-opacity-60 relative flex flex-row rounded-lg p-1">
                            <li
                                role="tab"
                ...
                <thead>
                    <tr>
                        <th class="border-blue-gray-100 bg-blue-gray-50/50 border-y p-4">
                            <p class="text-blue-gray-900 block font-sans text-sm leading-none font-normal antialiased opacity-70">Member</p>
                        </th>
                        <th class="border-blue-gray-100 bg-blue-gray-50/50 border-y p-4">
                            <p class="text-blue-gray-900 block font-sans text-sm leading-none font-normal antialiased opacity-70">Function</p>
                        </th>
                        <th class="border-blue-gray-100 bg-blue-gray-50/50 border-y p-4">
                            <p class="text-blue-gray-900 block font-sans text-sm leading-none font-normal antialiased opacity-70">Status</p>
                        </th>
                        <th class="border-blue-gray-100 bg-blue-gray-50/50 border-y p-4">
                            <p class="text-blue-gray-900 block font-sans text-sm leading-none font-normal antialiased opacity-70">Action</p>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="border-blue-gray-50 border-b p-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex flex-col">
                                    <p class="text-blue-gray-900 block font-sans text-sm leading-normal font-normal antialiased">John Michael</p>
                                    <p class="text-blue-gray-900 block font-sans text-sm leading-normal font-normal antialiased opacity-70">
                        ...
                        <td class="border-blue-gray-50 border-b p-4">
                            <div class="flex flex-col">
                                <p class="text-blue-gray-900 block font-sans text-sm leading-normal font-normal antialiased">Manager</p>
                                <p class="text-blue-gray-900 block font-sans text-sm leading-normal font-normal antialiased opacity-70">
                                    Organization
                                </p>
                            </div>
                        ...
                        <td class="border-blue-gray-50 border-b p-4">
                            <button
                                class="relative h-10 max-h-[40px] w-6 max-w-[40px] rounded-lg text-center align-middle font-sans text-xs font-medium text-gray-900 uppercase transition-all select-none hover:bg-gray-900/10 active:bg-gray-900/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                                type="button"
                            >
                            ...
                            <button
                                ...
                                type="button"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 540 640" class="h-5 w-5">
                                    <path
                    ...
                    <tr>
                        <td class="border-blue-gray-50 border-b p-4">
                            <div class="flex items-center gap-3">
                                ...
                                />
                                <div class="flex flex-col">
                                    <p class="text-blue-gray-900 block font-sans text-sm leading-normal font-normal antialiased">Laurent Perrier</p>
                                    <p class="text-blue-gray-900 block font-sans text-sm leading-normal font-normal antialiased opacity-70">
                        ...
                        <td class="border-blue-gray-50 border-b p-4">
                            <div class="flex flex-col">
                                <p class="text-blue-gray-900 block font-sans text-sm leading-normal font-normal antialiased">Executive</p>
                                <p class="text-blue-gray-900 block font-sans text-sm leading-normal font-normal antialiased opacity-70">Projects</p>
                            </div>
                        </td>
                        <td class="border-blue-gray-50 border-b p-4">
                            <div class="w-max">
                    ...
                    <tr>
                        <td class="border-blue-gray-50 border-b p-4">
                            <div class="flex items-center gap-3">
                                ...
                                />
                                <div class="flex flex-col">
                                    <p class="text-blue-gray-900 block font-sans text-sm leading-normal font-normal antialiased">Michael Levi</p>
                                    <p class="text-blue-gray-900 block font-sans text-sm leading-normal font-normal antialiased opacity-70">
                        ...
                        <td class="border-blue-gray-50 border-b p-4">
                            <div class="flex flex-col">
                                <p class="text-blue-gray-900 block font-sans text-sm leading-normal font-normal antialiased">Programator</p>
                                <p class="text-blue-gray-900 block font-sans text-sm leading-normal font-normal antialiased opacity-70">Developer</p>
                            </div>
                        </td>
                        <td class="border-blue-gray-50 border-b p-4">
                            <div class="w-max">
                    ...
                    <tr>
                        <td class="p-4">
                            <div class="flex items-center gap-3">
                                ...
                                />
                                <div class="flex flex-col">
                                    <p class="text-blue-gray-900 block font-sans text-sm leading-normal font-normal antialiased">Richard Gran</p>
                                    <p class="text-blue-gray-900 block font-sans text-sm leading-normal font-normal antialiased opacity-70">
                        ...
                        <td class="p-4">
                            <div class="flex flex-col">
                                <p class="text-blue-gray-900 block font-sans text-sm leading-normal font-normal antialiased">Manager</p>
                                <p class="text-blue-gray-900 block font-sans text-sm leading-normal font-normal antialiased opacity-70">Executive</p>
                            </div>
                        </td>
                        <td class="p-4">
                            <div class="w-max">
        ...
        <div class="border-blue-gray-50 flex items-center justify-between border-t p-4">
            <p class="text-blue-gray-900 block font-sans text-sm leading-normal font-normal antialiased">Page 1 of 10</p>
