    ...
    <div class="space-y-6">
        ...
        <div class="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
            <div class="relative space-y-0.5 text-red-600 dark:text-red-100">
                ...
                <p class="text-sm">Por favor, prossiga com atenção, esta ação não pode ser desfeito.</p>
            </div>
            <Dialog>
                <DialogTrigger as-child>
                    <Button variant="destructive" class="cursor-pointer">Excluir conta</Button>
                </DialogTrigger>
                <DialogContent>
                    <form class="space-y-6" @submit="deleteUser">
                        <DialogHeader class="space-y-3">
                            ...
                            <DialogDescription>
                                Assim que sua conta for excluída, todos os seus recursos e dados também serão excluídos
                                permanentemente.<br>
                        ...
                        <DialogFooter class="gap-2">
                            <DialogClose as-child>
                                <Button variant="secondary" @click="closeModal" class="cursor-pointer"> Cancelar
                                </Button>
                            </DialogClose>

                            <Button type="submit" variant="destructive" :disabled="form.processing"
                                class="cursor-pointer"> Excluir conta
                            </Button>
                        </DialogFooter>
                    </form>
                </DialogContent>
